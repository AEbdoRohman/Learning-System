        ...
        <div className="flex flex-col items-center md:items-end justify-center w-[100%] md:w-[20%]">
          ...
          <form action="" className=" flex flex-row-reverse my-[15px]">
            <input
              ...
              type="email"
              className="rounded-tl-none rounded-bl-none px-[10px] text-right border-gray-400 border-[1px] w-[75%] h-[30px] rounded-[10px] bg-gray-100 focus:border-[#525fe1] focus:outline-none"
            />
            <button className="mx-auto w-[130px] md:w-[100px] rounded-tr-none rounded-br-none  text-white rounded-[10px]   bg-hoverColor">
              أشترك
            </button>
          </form>
        </div>
