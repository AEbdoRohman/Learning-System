    ...
    <div>
      <div>
        ...
        <p className="mb-10 text-lg text-gray-700">
          ...
          molestiae iure tenetur repellat eveniet nostrum iste distinctio
          aspernatur saepe voluptate mollitia ullam maxime eius, doloribus
          voluptatem, minus nemo illum rerum?
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mb-10 text-lg text-gray-700">
          ...
          officia non consequatur laudantium hic sed, placeat commodi quidem eum
          voluptatibus.
        </p>
      </div>
    </div>
